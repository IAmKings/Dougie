...
object AppOfflineModels {
    val offers = OfficialModelCatalog.standard(
        ...
        embedModel = ModelSource(BuildConfig.EMBED_MODEL_URL, BuildConfig.EMBED_MODEL_SHA256),
        embedVocab = ModelSource(BuildConfig.EMBED_VOCAB_URL, BuildConfig.EMBED_VOCAB_SHA256),
