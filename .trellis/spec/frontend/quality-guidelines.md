...
| `:feature:history` | `HistoryItemTest` (incl. `toHistorySections` two-window grouping, 「默认会话」/「对话 2」, most-recently-active first) | `./gradlew :feature:history:testDebugUnitTest` |
