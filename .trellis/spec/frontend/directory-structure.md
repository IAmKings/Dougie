...
| Module | Owns |
|--------|------|
| `:feature:chat` | Chat Compose UI, `ChatViewModel`, bubble mapping, Confirm Card; top bar Dougie + current window name (display only) + 灵魂 + 出境; navigate to settings / memory / Permission Center |
