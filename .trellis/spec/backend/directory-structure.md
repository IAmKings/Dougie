...
|--------|------|----------------|
| `:core:model` | Data classes, enums, `LlmResponse`, `LlmEvent`, `ToolContext`, `EgressPolicy`, `CloudLlmConfig`, `LlmVendors`, `ConversationHit`, `conversationDisplayName` / `normalizeConversationTitle` | I/O, Android, HTTP |
