...
|--------|------|----------------|
| `:core:model` | Data classes, enums, `LlmResponse`, `LlmEvent`, `ToolContext`, `EgressPolicy`, `CloudLlmConfig`, `LlmVendors`, `ConversationHit`, `conversationDisplayName` / `normalizeConversationTitle`, `formatTaskDuration` | I/O, Android, HTTP |
