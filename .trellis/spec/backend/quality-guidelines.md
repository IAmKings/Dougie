...
| Memory gate / FTS / hybrid recall | `MemoryGateTest`, `HybridMemoryStoreTest` (not-ready = keyword; ready Fake paraphrase; search does not await backfill); Android SQLite stays in `:data:memory` | `./gradlew :core:memory:test` |
