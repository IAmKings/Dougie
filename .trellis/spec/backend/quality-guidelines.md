...
| Tool JSON, gates, model install/import | Matching `*ToolTest` / `ModelInstallerTest` / `ModelImporterTest`; `OfficialModelCatalogTest` pins embed as two HF files (~24MB, `isConfigured`) | `./gradlew :core:tool:test` |
