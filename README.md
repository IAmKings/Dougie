...
当前 **v0.1.4**（`versionCode` 104）已用仓库上传密钥签名，**尚未上架任何应用商店**。若装过更早的 debug 签名包，须先卸载再装。同签名升级可覆盖安装。
...
系统要求 **Android 8.0+**（`minSdk` 26）。从 [GitHub Releases](https://github.com/IAmKings/Dougie/releases) 下载两个渠道包之一（当前 [v0.1.4](https://github.com/IAmKings/Dougie/releases/tag/v0.1.4)）：
